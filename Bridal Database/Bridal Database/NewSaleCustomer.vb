...
Public Class NewSaleCustomer
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        ' Loop through each character in tel1 to ensure it contains only numbers
        ...
        ' Loop through each character in tel2 to ensure it contains only numbers
        ...
        If bust < 0 Or bust > 100 Or Not (IsNumeric(bust)) Then
            bustCheck = False
        End If
        If waist < 0 Or waist > 100 Or Not (IsNumeric(waist)) Then
            waistCheck = False
        End If
        If hips < 0 Or hips > 100 Or Not (IsNumeric(hips)) Then
            hipsCheck = False
        End If
