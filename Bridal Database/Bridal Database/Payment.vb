...
Public Class Payment
    ...
    Sub retrieveBalance()
        ...
        If reader2.Read() Then
            ...
            balance = Convert.ToDecimal(reader2("Balance"))
            'Display it in order total and remaining balance
            txtOrderTotal.Text = balance
            txtRemaining.Text = balance
        End If

    End Sub

    ' Runs when the Payment form loads, starts a timer with an interval of 1 second and copies order total from previous stage in sale
    ...
    Private Sub Timer1_Tick(sender As Object, e As EventArgs) Handles Timer1.Tick
        ...
        ElseIf Payment_History.addPayment = 1 Then
            If txtCID.Text <> "" Then
                ' update txtRemaining with the calculated balance
                txtRemaining.Text = balance
            End If
        End If
